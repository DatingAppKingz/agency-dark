"""Seed database with plain text passwords."""
import asyncio
import os
...
async def clear_database():
    ...
    async with AsyncSessionLocal() as session:
        try:
            ...
            await session.execute(text("DELETE FROM agencies"))
...
async def seed_database():
    """Seed database with test data using plain text passwords."""
    async with AsyncSessionLocal() as session:
        try:
            ...
            # 2. Create users with plain text passwords
            ...
            print(f"✓ Created {len(users_data) + 1} users with plain text passwords")
            
            await session.commit()
            print("\n✅ Test data seeded successfully with plain text passwords!")
            ...
            print("\n" + "="*60)
            print("TEST CREDENTIALS - ALL PASSWORDS: admin123 (plain text)")
            print("="*60)
            ...
            print("\n🟢 AGENCY OWNERS")
            print("  Elite Models: owner@elitemodels.com / admin123")
            print("  Premium Talent: owner@premiumtalent.com / admin123")
            print("  Rising Stars: owner@risingstars.com / admin123")
            
            print("\n🟡 AGENCY ADMINS")
            print("  Elite Models: admin@elitemodels.com / admin123")
            
            print("\n🟣 MODELS")
            print("  Sarah (Elite): sarah@elitemodels.com / admin123")
            print("  Emma (Elite): emma@elitemodels.com / admin123")
            print("  Lisa (Elite): lisa@elitemodels.com / admin123")
            print("  Jessica (Premium): jessica@premiumtalent.com / admin123")
            print("  Ashley (Premium): ashley@premiumtalent.com / admin123")
            print("  Sophia (Rising): sophia@risingstars.com / admin123")
            
            print("\n🟠 CHATTERS")
            print("  John (Elite): john@elitemodels.com / admin123")
            print("  Mike (Elite): mike@elitemodels.com / admin123")
            print("  Alex (Premium): alex@premiumtalent.com / admin123")
            
            print("\n⚪ AGENCY MEMBERS")
            print("  Support (Elite): support@elitemodels.com / admin123")
            
            print("\n⚠️  Note: Passwords are now stored in plain text!")
...
async def main():
    """Main function."""
    print("🌱 Seeding database with plain text passwords...")
    await seed_database()
