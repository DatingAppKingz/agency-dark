"""Final seed script with proper order."""
import asyncio
import os
...
async def seed_database():
    ...
    async with AsyncSessionLocal() as session:
        try:
            ...
            # 1. Create agencies first (without owner_id since that column doesn't exist)
            print("Creating agencies...")
            await session.execute(text("""
                INSERT INTO agencies (id, name, is_active, created_at, updated_at) 
                VALUES 
                (:id1, :name1, true, NOW(), NOW()),
                (:id2, :name2, true, NOW(), NOW()),
                (:id3, :name3, true, NOW(), NOW())
            """), {
            ...
            print("\nKey logins:")
            print("  Super Admin: admin@agency.com")
            print("  Agency Owner: owner@elitemodels.com")
            print("  Agency Admin: admin@elitemodels.com")
            print("  Model: sarah@elitemodels.com")
            print("  Chatter: john@elitemodels.com")
            print("  Member: support@elitemodels.com")
